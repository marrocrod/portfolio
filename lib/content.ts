  ...
  quantum: {
    ...
    demos: [
      ...
      },
      {
        ...
        summary:
          "One optimization problem, two approaches. Simulated annealing and QAOA solve the same QUBO side by side, with the cost of each declared.",
        capabilities: [
          "Pick a number-partitioning, independent-set or random QUBO, or paste your own matrix.",
          "Watch simulated annealing cool down and QAOA train layer by layer, against the exact optimum.",
          "Compare how often each one finds the best solution as the problem grows from 4 to 12 variables.",
        ],
        stack: ["Simulated annealing (Metropolis)", "TypeScript state-vector simulator", "INTERP layer-by-layer training", "SVG charts"],
        status: "live",
      },
    ],
  },
